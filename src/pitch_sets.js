...
const pitchSetBassC = {
  choose: [
    ...
    [Tone.Frequency('C3'), Tone.Frequency('Bb2')],
    Tone.Frequency('F3'),
    [Tone.Frequency('F3'), Tone.Frequency('C3')], Tone.Frequency('G3'),
    Tone.Frequency('G3'),
    [Tone.Frequency('G3'), Tone.Frequency('Eb3')],
  ],
};
...
const pitchSetBassD = {
  choose: [
    ...
    [Tone.Frequency('G3'), Tone.Frequency('Eb3')],
    Tone.Frequency('C4'),
    [Tone.Frequency('C4'), Tone.Frequency('Bb3')],
    Tone.Frequency('F4'),
    [Tone.Frequency('F4'), Tone.Frequency('C4')],
  ],
};
...
const pitchSetD = {
  choose: [
    [Tone.Frequency('G3'), Tone.Frequency('Bb4')],
    Tone.Frequency('C4') * centsAdd(35),
    Tone.Frequency('C4'),
    Tone.Frequency('Eb4') * centsAdd(35),
    Tone.Frequency('Eb4'),
    Tone.Frequency('Eb4'),
    Tone.Frequency('Eb4'),
    [Tone.Frequency('Eb4'), Tone.Frequency('F5')],
    Tone.Frequency('F4'),
    Tone.Frequency('F4'),
    Tone.Frequency('F4'),
    Tone.Frequency('G4') * centsAdd(35),
    Tone.Frequency('G4') * centsAdd(50),
    Tone.Frequency('G4'),
    Tone.Frequency('G4'),
    Tone.Frequency('G4'),
    Tone.Frequency('Bb4'),
    ...
    Tone.Frequency('Bb4'),
    Tone.Frequency('Bb4'),
    [Tone.Frequency('Bb4'), Tone.Frequency('C5')],
    Tone.Frequency('C5') * centsAdd(35),
    Tone.Frequency('Eb5') * centsAdd(35),
    [Tone.Frequency('Eb5'), Tone.Frequency('F6')],
    Tone.Frequency('Eb5'),
    Tone.Frequency('Eb5'),
    Tone.Frequency('Eb5'),
    [Tone.Frequency('F5') * centsAdd(35), Tone.Frequency('Eb5')],
...
const pitchSetHiB = {
  choose: [
    ...
    Tone.Frequency('Bb5') * eighthTone,
    Tone.Frequency('Bb5') * eighthTone,
    [Tone.Frequency('C6') * centsAdd(50), Tone.Frequency('F6') * centsAdd(-50)],
    Tone.Frequency('C6'),
    Tone.Frequency('Eb6') * eighthTone,
    Tone.Frequency('Eb6'),
    ...
    Tone.Frequency('G6') * eighthTone,
    [Tone.Frequency('G6') * centsAdd(50), Tone.Frequency('Bb6') * centsAdd(50)],
    Tone.Frequency('Bb6'),
    Tone.Frequency('Bb6'),
    Tone.Frequency('Bb6'),
    ...
    Tone.Frequency('Eb7'),
    [Tone.Frequency('Eb7') * centsAdd(50), Tone.Frequency('F7') * centsAdd(50)],
    Tone.Frequency('F7') * betweenTone,
    [Tone.Frequency('F7') * betweenTone, Tone.Frequency('F7')],
    Tone.Frequency('G7'),
    Tone.Frequency('G7') * eighthTone,
    Tone.Frequency('G7') * eighthTone,
    [Tone.Frequency('G7') * centsAdd(50), Tone.Frequency('Bb7') * centsAdd(50)],
  ],
};
