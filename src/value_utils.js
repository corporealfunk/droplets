...
const CENTS_CONSTANT = 1.00057778950655;

const centsAdd = (cents) => CENTS_CONSTANT ** cents;

const quarterTone = centsAdd(50);
const betweenTone = centsAdd(35);
const eighthTone = centsAdd(25);
